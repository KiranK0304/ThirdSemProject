...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["talentwright.ai"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Talentwright <noreply@talentwright.ai>",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [
    {"url": "https://talentwright.ai", "description": "Production server"},
]
# Your stuff...
# ------------------------------------------------------------------------------
